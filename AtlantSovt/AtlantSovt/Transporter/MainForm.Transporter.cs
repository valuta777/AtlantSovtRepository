        ...
        void ShowTransporter()
        {
            ...
            using (var db = new AtlantSovtContext())
            {
                ...
                new
                {
                    ...
                    ShortName = t.ShortName.ToString(),
                    Director = t.Director.ToString(),
                    PhysicalAddress = t.PhysicalAddress.ToString(),
                    GeographyAddress = t.GeographyAddress.ToString(),
                    TaxPayerStatusId = t.TaxPayerStatu.Status.ToString(),
                    WorkDocumentId = t.WorkDocument.Status.ToString(),
                };


                transporterShowDataGridView.DataSource = ConvertToDataTable(query);
        ...
        void SplitUpdateTransporter()
        {
            using (var db = new AtlantSovtContext())
            {
                ...
                if (transporter != null)
                {
                    ...
                    {
                        workDocumentTransporterUpdateComboBox.SelectedIndex = workDocumentTransporterUpdateComboBox.FindString(transporter.WorkDocument.Status + " [" + transporter.WorkDocument.Id + ']');
                    }
                    else 
                    {
                    ...
                    {
                        taxPayerStatusTransporterUpdateComboBox.SelectedIndex = taxPayerStatusTransporterUpdateComboBox.FindString(transporter.TaxPayerStatu.Status + " [" + transporter.TaxPayerStatu.Id + ']');   
                    }
                    else
                    {
