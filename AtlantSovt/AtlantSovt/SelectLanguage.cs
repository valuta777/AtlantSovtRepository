...
namespace MultiLang
{
    public partial class SelectLanguage : Form
    {
        ...
        private static string[] SupportedCultures = { "uk-UA", "ru-RU" } ; //MLHIDE
...
" +
                                        AtlantSovt.Properties.Resources.The_language_change_will_take_,
                                        AtlantSovt.Properties.Resources.Select_language,
            ...
            if (isoStorage.GetFileNames("CultureSettings.xml").Length > 0) //MLHIDE
            {
                ...
                StreamReader stmReader = new StreamReader
                                             (new IsolatedStorageFileStream
                                                   (AtlantSovt.Properties.Resources.CultureSettings_xml,
                                                    FileMode.Open,
                                                    isoStorage)); //MLHIDE
